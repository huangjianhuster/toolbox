...
#parser.add_argument('-u', '--upper', help='residue id to define the upper plane of the truncated cone', required=True)
...
#lower_residue = args.lower
#higher_residue = args.upper
...
surrounding_chloride = target_system.select_atoms("resname CLA and around 10 resid %s" % args.resid)
print(len(surrounding_chloride))
