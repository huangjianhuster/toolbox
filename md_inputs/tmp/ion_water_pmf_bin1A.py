...
# bin_min, bin_max
ion_pmf = get_pmf(K_z, bin_num=bin_num, bin_min=bin_min, bin_max=bin_max, saved_name=f"{output_suffix}_dG_ion_bin1A.dat")
ion_density = get_density(K_z, bin_num=bin_num, bin_min=bin_min, bin_max=bin_max, saved_name=f"{output_suffix}_ion_density_b1A_cf4.dat")
water_density = get_density(O_z, bin_num=bin_num, bin_min=bin_min, bin_max=bin_max, saved_name=f"{output_suffix}_water_density_b1A_cf4.dat")
